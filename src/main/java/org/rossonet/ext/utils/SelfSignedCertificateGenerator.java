...
public class SelfSignedCertificateGenerator {
	...
	public X509Certificate generateSelfSigned(KeyPair keyPair, Date notBefore, Date notAfter,
			...
			@Nullable String applicationUri, List<String> dnsNames, List<String> ipAddresses, String signatureAlgorithm)
			throws Exception {
		...
		final X509v3CertificateBuilder certificateBuilder = new X509v3CertificateBuilder(name, certSerialNumber,
				notBefore, notAfter, Locale.ENGLISH, name, subjectPublicKeyInfo);
